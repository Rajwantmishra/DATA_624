...
No transformation for RI, Na, Si, and K since λ=1.
Log transformations for Mg, K, Ba, and Fe since λ≈0.
Square root transformation for Ca since λ=0.5.
...
We can previous the new dataset fro missing values with aggr from VIM package
